...
def test_ai_call_118_exposes_livekit_sip_without_rtp_port_proxies() -> None:
    ...
    assert '"127.0.0.1:16379:6379/tcp"' in compose
    assert "network_mode: host" in compose
    assert '"172.17.16.12:10000-20000:10000-20000/udp"' not in compose
    assert "listen_ip: 172.17.16.12" in sip_config
    assert "nat_1_to_1_ip: 118.25.125.221" in sip_config
    assert "use_external_ip: false" in sip_config
