...
2. [phases/phase-a-e2e-core-engine.md](phases/phase-a-e2e-core-engine.md)：当前 Phase A 技术设计。
3. [CALL_SCENARIOS.md](CALL_SCENARIOS.md)：通话中通用场景和验收清单。

后续阶段预设计：[phases/phase-b-web-commercial-loop-pre-design.md](phases/phase-b-web-commercial-loop-pre-design.md)。预设计不是当前实施依据，进入对应阶段前必须基于上一阶段结果更新。
