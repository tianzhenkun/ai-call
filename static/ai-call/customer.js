...
const LINPHONE_DEFAULT_CALLEE_NUMBER = "19900001001";
...
const EVENT_TYPE_LABELS = {
  ...
  audio_playout_queue_watermark: "AI 音频队列达到高水位",
  audio_playout_queue_full: "AI 音频队列溢出",
  audio_playout_response_failed: "AI 音频回复播放失败",
