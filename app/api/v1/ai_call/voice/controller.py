...
from .service import VoiceEnrollmentService
...
async def create_voice_preview_controller(
    ...
    return SuccessResponse(data=result, msg="试听会话创建成功")
...
async def ready_voice_preview_controller(
    ...
    return SuccessResponse(data=result, msg="试听会话已就绪")
...
async def close_voice_preview_controller(
    ...
    return SuccessResponse(data=result, msg="试听会话已关闭")
