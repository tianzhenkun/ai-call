...
class Settings(BaseSettings):
    ...
    AI_CALL_RUNTIME_INSTANCE_ID: str = ""
    AI_CALL_RUNTIME_CAPACITY: int = 20
    AI_CALL_RUNTIME_CLEANUP_CAPACITY: int = 4
    AI_CALL_RUNTIME_WORKER_LEASE_SECONDS: float = 30.0
    AI_CALL_RUNTIME_OWNER_LEASE_SECONDS: float = 15.0
    AI_CALL_RUNTIME_RENEW_INTERVAL_SECONDS: float = 5.0
    AI_CALL_RUNTIME_COMMAND_LEASE_SECONDS: float = 30.0
    AI_CALL_RUNTIME_EFFECT_LEASE_SECONDS: float = 30.0
    AI_CALL_RUNTIME_END_SCAN_INTERVAL_SECONDS: float = 0.5
    AI_CALL_RUNTIME_COMMAND_SCAN_INTERVAL_SECONDS: float = 1.0
    AI_CALL_RUNTIME_FAIL_CLOSED_MARGIN_SECONDS: float = 3.0
    AI_CALL_RUNTIME_PROVIDER_MODE: Literal["stub", "livekit"] = "stub"
    AI_CALL_RUNTIME_REAL_PROVIDER_ALLOWED: bool = False
    ...
    AI_CALL_KNOWLEDGE_UPLOAD_RECONCILE_AFTER_SECONDS: int = 3600
    AI_CALL_KNOWLEDGE_PARSER_SOCKET: str = ""
    AI_CALL_KNOWLEDGE_PARSER_TIMEOUT_SECONDS: float = 30.0
    ...
    AI_CALL_OUTBOUND_QUEUED_LIMIT_PER_TENANT: int = 100
    AI_CALL_OUTBOUND_QUEUED_LIMIT_PER_TASK: int = 20
    AI_CALL_OUTBOUND_QUEUED_LIMIT_PER_LINE: int = 50
    AI_CALL_OUTBOUND_ALLOCATION_TIMEOUT_SECONDS: float = 30.0
    AI_CALL_OUTBOUND_DIALING_TIMEOUT_SECONDS: int = 300
    AI_CALL_OUTBOUND_TIMEZONE: str = "Asia/Shanghai"
    AI_CALL_MANUAL_CALLBACK_WINDOW_START: str = "09:00"
    AI_CALL_MANUAL_CALLBACK_WINDOW_END: str = "21:00"
    ...
    AI_CALL_VOICE_WORKER_SHUTDOWN_GRACE_SECONDS: float = 30.0
    ...
    AI_CALL_QUALITY_SCORING_ENABLED: bool = True
    AI_CALL_QUALITY_SCORING_MODEL: str = ""
