    ...
    *,
    ...
    for candidate in candidates:
        if candidate["index"] in matched_candidate_indexes:
            continue
        windows.append(_candidate_only_window(call_id=call_id, candidate=candidate))
...
def _candidate_only_window(*, call_id: str, candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "preStopTime": None,
        "decisionTime": None,
        "decisionEventType": None,
        "decisionReason": None,
        "providerSpeechStarted": False,
...
def _quality_report(
    *,
    ...
    return {
        "passed": not missed_speech and not slow_ends,
    ...
    *,
    ...
    for segment in customer_segments:
        ...
        missed.append({
            ...
            "nearestCandidateToSpeechStartMs": _elapsed_from_time_ms(
                segment["startedAt"],
                nearest_candidate,
            ),
